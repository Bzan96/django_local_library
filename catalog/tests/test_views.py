...
class AuthorListViewTest(TestCase):
    ...
    def test_lists_all_authors(self):
        # Get second page and confirm it has (exactly) remaining 3
...
class LoanedBooksByUserListView(TestCase):
    def setUp(self):
        ...
        test_genre = Genre.objects.create(genreType="Fantasy")
        test_language = Language.objects.create(language="English")
        test_book = Book.objects.create(title="Book Title", summary = "My book summary", isbn="1234567890", author=test_author, language=test_language)
    ...
    def test_logged_in_uses_correct_template(self):
        ...
        # Check our user is not logged in
